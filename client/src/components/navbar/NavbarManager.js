...
export default function NavbarAdmin({ handleLogout }) {
    ...
    return (
        <nav className="nav" >
            ...
            <ul>
                <DropdownButton id="split-button-dropdown " title="Schedule Management"
                ...
                <DropdownButton id="split-button-dropdown " title="Leave Management" className="custom-dropdown-button" >
